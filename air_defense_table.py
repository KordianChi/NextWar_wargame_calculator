...
class AirCombatTable(Toplevel):
    def __init__(self, parent):
        ...
        self.lbl10.place(x=50, y=30)
        self.lbl11.place(x=50, y=60)
        self.c6.place(x=50, y=90)
        self.c7.place(x=50, y=120)
        self.c8.place(x=50, y=150)
        self.c9.place(x=50, y=180)
        self.c10.place(x=50, y=210)
        self.c11.place(x=50, y=240)
        self.c12.place(x=50, y=270)
        self.c13.place(x=50, y=300)
        self.lbl12.place(x=50, y=330)
        self.btn2.place(x=50, y=360)
        self.lbl13.place(x=50, y=390)
        self.lbl14.place(x=50, y=420)
        self.lbl15.place(x=50, y=450)
        self.cb3.place(x=150, y=30)
        self.cb4.place(x=150, y=60)
        self.cb5.place(x=150, y=330)
        self.t6.place(x=150, y=390)
        self.t7.place(x=150, y=420)
        self.t8.place(x=150, y=450)
        self.lbl4.place(x=250, y=330)
        self.r4.place(x=250, y=360)
        self.r5.place(x=250, y=390)
        self.r6.place(x=250, y=420)
        self.lbl16.place(x=250, y=30)
        self.c14.place(x=250, y=60)
        self.c15.place(x=250, y=90)
        self.c16.place(x=250, y=120)
        self.c17.place(x=250, y=150)
        self.lbl17.place(x=250, y=180)
        self.btn3.place(x=250, y=210)
        self.lbl19.place(x=250, y=240)
        self.lbl18.place(x=250, y=270)
        self.lbl20.place(x=250, y=300)
        self.cb6.place(x=350, y=30)
        self.cb7.place(x=350, y=180)
        self.t9.place(x=350, y=240)
        self.t10.place(x=350, y=270)
        self.t11.place(x=350, y=300)
        self.lbl21.place(x=450, y=30)
        self.c18.place(x=450, y=60)
        self.c19.place(x=450, y=90)
        self.c20.place(x=450, y=120)
        self.c21.place(x=450, y=150)
        self.c22.place(x=450, y=180)
        self.btn4.place(x=450, y=210)
        self.lbl22.place(x=450, y=240)
        self.lbl23.place(x=450, y=270)
        self.lbl24.place(x=450, y=300)
        self.cb8.place(x=550, y=30)
        self.t12.place(x=550, y=240)
        self.t13.place(x=550, y=270)
        self.t14.place(x=550, y=300)
