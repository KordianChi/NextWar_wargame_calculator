...
class StrikeTable(Toplevel):
    ...
    def __init__(self, parent):
        ...
        self.strike_d10_ent = Entry(self, width=10)

        self.strike_drm_lbl = Label(self, text='Strike DRM:')
        self.strike_drm_ent = Entry(self, width=10)

        self.strike_result_lbl = Label(self, text='Strike Result:')
        self.strike_result_ent = Entry(self, width=10)
        ...
        self.damage_btn = Button(self, text='Damage', command=self.calculate_damage)

        self.collateral_damage_ent = Entry(self, width=12)
        self.d10_coll_ent = Entry(self, width=10)
