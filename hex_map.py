...
hex_map.add_hex(0, 0, 1)
hex_map.add_hex(0, 1, 1)
hex_map.add_hex(0, 2, 2)
hex_map.add_hex(0, 3, 3)

hex_map.add_hex(1, 0, 2)
hex_map.add_hex(1, 1, 2)
hex_map.add_hex(1, 2, 1)
hex_map.add_hex(1, 3, 2)

hex_map.add_hex(2, 0, 1)
hex_map.add_hex(2, 1, 3)
hex_map.add_hex(2, 2, 1)
hex_map.add_hex(2, 3, 1)

hex_map.add_hex(3, 0, 1)
hex_map.add_hex(3, 1, 2)
hex_map.add_hex(3, 2, 1)
hex_map.add_hex(3, 3, 2)

hex_map.add_road(0, 0, 0, 1, 0.5)
hex_map.add_road(0, 1, 1, 1, 0.5)
hex_map.add_road(1, 1, 2, 1, 0.5)
hex_map.add_road(2, 1, 2, 0, 0.5)

hex_map.add_road(2, 3, 2, 2, 0.5)
hex_map.add_road(2, 2, 3, 1, 0.5)

hex_map.add_road(0, 3, 1, 2, 0.5)

hex_map.add_river(0, 2, 0, 3, 5)
hex_map.add_river(0, 2, 1, 2, 5)
hex_map.add_river(1, 1, 1, 2, 5)
hex_map.add_river(1, 1, 2, 2, 5)
hex_map.add_river(2, 1, 2, 2, 5)
hex_map.add_river(2, 1, 3, 1, 5)
hex_map.add_river(3, 0, 3, 1, 5)

hex_map.add_river(1, 2, 2, 2, 5)
hex_map.add_river(1, 2, 2, 3, 5)
hex_map.add_river(2, 3, 1, 3, 5)
