...
class AirToAirCombatTable(Toplevel):
    def __init__(self, parent):
        ...
        self.attacker_value_lbl.place(x=50, y=30)
        self.attacker_pilot_skills_lbl.place(x=50, y=60)
        self.defender_value_lbl.place(x=250, y=30)
        self.defender_pilot_skills_lbl.place(x=250, y=60)
        self.attacker_value_cbx.place(x=150, y=30)
        self.attacker_pilot_skills_cbx.place(x=150, y=60)
        self.defender_value_cbx.place(x=350, y=30)
        self.defender_pilot_skills_cbx.place(x=350, y=60)
        self.strike_def_chk.place(x=250, y=90)
        self.not_proper_def_chk.place(x=250, y=120)
        ...
        self.strike_att_chk.place(x=50, y=90)
        self.not_proper_att_chk.place(x=50, y=120)
        self.air_2_air_btn.place(x=50, y=150)
        self.d10_att_ent.place(x=150, y=210)
        self.DRM_att_ent.place(x=150, y=180)
        self.result_att_ent.place(x=150, y=240)
        self.d10_def_ent.place(x=350, y=210)
        self.DRM_def_ent.place(x=350, y=180)
        self.result_def_ent.place(x=350, y=240)
        self.not_mutual_chk.place(x=150, y=150)
        self.attacker_d10_lbl.place(x=50, y=210)
        self.attacker_drm_lbl.place(x=50, y=180)
        self.attacker_result_lbl.place(x=50, y=240)
        self.defender_d10_lbl.place(x=250, y=210)
        self.defender_drm_lbl.place(x=250, y=180)
        self.defender_result_lbl.place(x=250, y=240)
